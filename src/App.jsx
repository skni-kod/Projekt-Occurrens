...
import VisitSelection from "./components/userNotLoggedIn/visitSelection/visitSelection";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "about", element: <VisitSelection /> },//bedzie chwilowo pozmieniane - tutaj ma być aboutPage!!
