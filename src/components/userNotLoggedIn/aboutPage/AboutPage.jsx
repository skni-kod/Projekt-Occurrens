...
// trzeba wysrodkowac tekst i otoczenie buttona tez ma byc niebieskie
function AboutContent() {
  return (
    <div style={{
      ...
      <p className='mainTitle'>O Projekcie Ocuurens</p>
      <br></br><br></br>
      <p className='mainContainer'>{tekst}</p>
      <br></br>
      <br></br>
      <button className='buttonLogin'>Dupa</button>
      <br></br><br></br>
