        ...
        <div className={styles.transparent}>
            <h1>Twój profil</h1>
                <div className={styles.doctorProfile}>
                    <div className={`${styles.userData} ${styles.gridBox}`}><h2>Dane użytkownika</h2>
                    ...
                    <div className={`${styles.specs} ${styles.gridBox}`}><h2>Specjalizacje</h2>
                        <div className={styles.specsList}>

                        </div>
                            <button className={styles.editDataButton}>Edytuj Dane</button>
                            <button className={styles.editSpecsButton}>Edytuj Specjalizacje</button>
                    </div>
                    <div className={`${styles.offices} ${styles.gridBox}`}><h2>Gabinety</h2>
                    <div className={styles.officesData}>
                                ...
                                <h4 className={styles.open}>Godziny otwarcia:</h4>        <div></div>
                            ...
                            <button className={styles.editOfficesButton}>Edytuj adresy i godziny</button>
                    </div>
                </div>
        </div>
    </div>
